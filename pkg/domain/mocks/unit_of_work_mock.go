...
//			CommitFunc: func(ctx context.Context) ([]Envelope, error) {
//				panic("mock out the Commit method")
//			},
//			RegisterEventsFunc: func(events []Event)  {
...
func (mock *UnitOfWorkMock) Commit(ctx context.Context) ([]Envelope, error) {
...
func (mock *UnitOfWorkMock) RegisterEvents(events []Event) {
