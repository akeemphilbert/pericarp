...
func TestEventStore_GetEventsRange(t *testing.T) {
	...
	tests := []struct {
		...
		// GORM store range test cases
		{
			name:        "gorm: get events from version 1 to 2",
		...
		{
			name:        "gorm: get events with default fromVersion (1)",
			setupStore:  setupGormStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: -1,
			toVersion:   2,
		...
		{
			name:        "gorm: get events with toVersion -1 (all remaining)",
			setupStore:  setupGormStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: 2,
			toVersion:   -1,
		...
		{
			name:        "gorm: get events with both defaults (all events)",
			setupStore:  setupGormStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: -1,
			toVersion:   -1,
		...
		{
			name:        "gorm: get events with range beyond existing",
			setupStore:  setupGormStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: 10,
			toVersion:   20,
		...
		// BigQuery store range test cases
		{
			name:        "bigquery: get events from version 1 to 2",
		...
		{
			name:        "bigquery: get events with default fromVersion (1)",
			setupStore:  setupBigQueryStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: -1,
			toVersion:   2,
		...
		{
			name:        "bigquery: get events with toVersion -1 (all remaining)",
			setupStore:  setupBigQueryStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: 2,
			toVersion:   -1,
		...
		{
			name:        "bigquery: get events with both defaults (all events)",
			setupStore:  setupBigQueryStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: -1,
			toVersion:   -1,
		...
		{
			name:        "bigquery: get events with range beyond existing",
			setupStore:  setupBigQueryStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: 10,
			toVersion:   20,
		...
		// Bigtable store range test cases
		{
			name:        "bigtable: get events from version 1 to 2",
		...
		{
			name:        "bigtable: get events with default fromVersion (1)",
			setupStore:  setupBigtableStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: -1,
			toVersion:   2,
		...
		{
			name:        "bigtable: get events with toVersion -1 (all remaining)",
			setupStore:  setupBigtableStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: 2,
			toVersion:   -1,
		...
		{
			name:        "bigtable: get events with both defaults (all events)",
			setupStore:  setupBigtableStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: -1,
			toVersion:   -1,
		...
		{
			name:        "bigtable: get events with range beyond existing",
			setupStore:  setupBigtableStoreWithMultipleEvents,
			aggregateID: "agg-4",
			fromVersion: 10,
			toVersion:   20,
